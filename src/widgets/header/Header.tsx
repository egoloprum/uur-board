  ...
  return (
    <header className="px-4 py-4 md:px-8 md:py-6 lg:px-12 lg:py-8 text-black flex justify-between overflow-hidden">
      <div className="relative">
        ...
        <Link href="/">
          <nav
            className={`h-fit w-fit text-black p-4 py-2 text-xl sm:text-4xl md:text-5xl lg:text-6xl shadow-2xl hover:scale-110 transition-all duration-300 ${randomFont} ${randomBgColor}`}
            style={{ ...rotationStyle }}
          >
            <p>ҮҮР</p>
          </nav>
      ...
      <div className="relative">
        ...
        <Link href="/about">
          <nav
            className={`h-fit w-fit text-black p-4 py-2 text-xl sm:text-2xl md:text-3xl lg:text-4xl shadow-2xl hover:scale-110 transition-all duration-300 ${randomFont} ${randomBgColor}`}
            style={{ ...rotationStyle }}
          >
            <p>Бидний тухай</p>
          </nav>
